...
pub fn file_tour_routes() -> Router<AppState> {
    Router::new()
        // Entradas
        .route("/{file_tour_id}/entradas", get(file_relations::list_file_tour_entradas))
        .route("/entradas", post(file_relations::assign_entrada_to_file_tour))
        .route("/entradas/{entrada_asig_id}", axum::routing::delete(file_relations::remove_file_entrada))
        .route("/entradas/{id}/status", patch(relation_status::update_file_entrada_status))
        // Restaurantes
        .route("/{file_tour_id}/restaurantes", get(file_relations::list_file_tour_restaurantes))
        .route("/restaurantes", post(file_relations::assign_restaurante_to_file_tour))
        .route("/restaurantes/{restaurante_asig_id}", axum::routing::delete(file_relations::remove_file_restaurante))
        .route("/restaurantes/{id}/status", patch(relation_status::update_file_restaurante_status))
        // Guías
        ...
        .route("/vehiculos", post(file_relations::assign_vehiculo_to_file_tour))
        ...
        .route("/{id}/recojo", patch(relation_status::update_file_tour_recojo))
}
